...
import web4 from "../assets/web4.avif";
import web5 from "../assets/web4.avif";
          ...
          {sliderItems.map((item, index) => (
            ...
            >
              <div className="content">
                ...
                <div className="btn">
                  <button className="px-6 py-3 bg-gradient-to-r from-blue-500 to-green-500 text-white font-semibold rounded-full shadow-lg hover:from-green-500 hover:to-blue-500 transition duration-300 ease-in-out">
                    <a
                      href="tel:+917439120030"
                      className="inline-block px-6 py-3 bg-gradient-to-r from-blue-500 to-green-500 text-white font-semibold rounded-full shadow-lg hover:from-green-500 hover:to-blue-500 transition duration-300 ease-in-out"
                    >
                      Let's Talk
                    </a>
                  </button>
