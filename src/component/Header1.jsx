  ...
  return (
    ...
    <section className="homedada" id="homedada">
      <div className="contentdada">
        ...
        <a href="#contact" className="btn bg-black text-white py-3 px-6 rounded-full font-semibold transition hover:bg-gray-800">
          Getting Started
        </a>
      </div>

      <div className="imagedada">
        <img src={marketing} alt="Marketing" className="w-full lg:w-1/2 object-cover" />
      </div>
    </section>
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-white py-12 px-4">
      ...
      <div className="max-w-5xl mx-auto flex flex-col lg:flex-row items-center gap-10">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          <h1 className="text-4xl font-bold mb-4">Your Business is just Growing.</h1>
